  ...
  render() {
    const listOne = [
      ...
      { id: 1, text: "list1", url: "./images/borage_235.png", name: "borage" },
      {
        id: 1,
        text: "list1",
        url: "./images/butterfly_milkweed_250.png",
        name: "butterfly milkweed"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/coneflowers_235.png",
        name: "coneflowers"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/large_leafed_aster_240.png",
        name: "large-leafed aster"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/lavender_157.png",
        name: "lavender"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/prairie_phlox_80.png",
        name: "prairie phlox"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/rattlesnake_master_252.png",
      ...
      { id: 1, text: "list1", url: "./images/sage_250.png", name: "sage" },
      {
        id: 1,
        text: "list1",
        url: "./images/swamp_milkweed_235.png",
        name: "swamp milkweed"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/virginia_waterleaf_215.png",
        name: "Virginia waterleaf"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/white_turtlehead_313.png",
        name: "white turtlehead"
      },
      {
        id: 1,
        text: "list1",
        url: "./images/wild_geranium_120.png",
        name: "wild geranium"
      }
    ];
